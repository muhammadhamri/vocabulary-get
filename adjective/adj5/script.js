...
const imageKotakSatu = document.querySelector(".imagekotaksatu");
const imageKotakDua = document.querySelector(".imagekotakdua");
const imageKotakTiga = document.querySelector(".imagekotaktiga");
const imageKotakEmpat = document.querySelector(".imagekotakempat");
const imageKotakLima = document.querySelector(".imagekotaklima");
const imageKotakEnam = document.querySelector(".imagekotakenam");
const imageKotakTujuh = document.querySelector(".imagekotaktujuh");
const imageKotakDelapan = document.querySelector(".imagekotakdelapan");
const imageKotakSembilan = document.querySelector(".imagekotaksembilan");
const imageKotakSepuluh = document.querySelector(".imagekotaksepuluh");
const imageKotakSebelas = document.querySelector(".imagekotaksebelas");
const imageKotakDuabelas = document.querySelector(".imagekotakduabelas");
const imageKotakTigabelas = document.querySelector(".imagekotaktigabelas");
const imageKotakEmpatbelas = document.querySelector(".imagekotakempatbelas");
const imageKotakLimabelas = document.querySelector(".imagekotaklimabelas");
const imageKotakEnambelas = document.querySelector(".imagekotakenambelas");
const imageKotakTujuhbelas = document.querySelector(".imagekotaktujuhbelas");
const imageKotakDelapanbelas = document.querySelector(".imagekotakdelapanbelas");
const imageKotakSembilanbelas = document.querySelector(".imagekotaksembilanbelas");
const imageKotakDuapuluh = document.querySelector(".imagekotakduapuluh");
